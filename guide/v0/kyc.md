...
the `BUY` operation. Assuming that this is the first transaction of that kind for a user and that the operation configuration was exactly as the example above, 
